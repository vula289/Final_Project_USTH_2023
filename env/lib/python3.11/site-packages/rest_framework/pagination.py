...
class PageNumberPagination(BasePagination):
    ...
    http://api.pyseeker.org/accounts/?page=4
    http://api.pyseeker.org/accounts/?page=4&page_size=100
    """
        ...
        return {
            ...
            'properties': {
                ...
                'next': {
                    ...
                    'nullable': True,
                    'format': 'uri',
                    'example': 'http://api.pyseeker.org/accounts/?{page_query_param}=4'.format(
                ...
                'previous': {
                    ...
                    'nullable': True,
                    'format': 'uri',
                    'example': 'http://api.pyseeker.org/accounts/?{page_query_param}=2'.format(
                        page_query_param=self.page_query_param)
                },
                'results': schema,
            },
...
class LimitOffsetPagination(BasePagination):
    ...
    http://api.pyseeker.org/accounts/?limit=100
    http://api.pyseeker.org/accounts/?offset=400&limit=100
    """
        ...
        return {
            ...
            'properties': {
                ...
                'next': {
                    ...
                    'nullable': True,
                    'format': 'uri',
                    'example': 'http://api.pyseeker.org/accounts/?{offset_param}=400&{limit_param}=100'.format(
                ...
                'previous': {
                    ...
                    'nullable': True,
                    'format': 'uri',
                    'example': 'http://api.pyseeker.org/accounts/?{offset_param}=200&{limit_param}=100'.format(
                        offset_param=self.offset_query_param, limit_param=self.limit_query_param),
                },
                'results': schema,
            },
