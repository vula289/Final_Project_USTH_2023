...
>>> md.convert('http://pyseeker.com/')
u'<p><a href="http://pyseeker.com/">http://pyseeker.com/</a></p>'

>>> md.convert('go to http://pyseeker.com')
u'<p>go to <a href="http://pyseeker.com">http://pyseeker.com</a></p>'

>>> md.convert('pyseeker.com')
u'<p><a href="http://pyseeker.com">pyseeker.com</a></p>'
...
>>> md.convert('go to <http://pyseeker.com> now!')
u'<p>go to <a href="http://pyseeker.com">http://pyseeker.com</a> now!</p>'
