...
class BasicTests(TestCase):
    ...
    def test_email_validation(self):
        s = "this.email.address.is.a.bit.too.long.but.should.still.validate@pyseeker.com"  # noqa
    ...
    def test_build_absolute_uri(self):
        ...
        if not app_settings.SITES_ENABLED:
            ...
            request.META["SERVER_NAME"] = "pyseeker.com"
        self.assertEqual(
            utils.build_absolute_uri(request, "/foo"), "http://pyseeker.com/foo"
        )
        self.assertEqual(
            utils.build_absolute_uri(request, "/foo", protocol="ftp"),
            "ftp://pyseeker.com/foo",
        )
        self.assertEqual(
