...
def parse_authorization_code_response(uri, state=None):
    ...
    **state**
    ...
    .. code-block:: http
        ...
        HTTP/1.1 302 Found
        Location: https://client.pyseeker.com/cb?code=SplxlOBeZQQYbYS6WxSbIA
                &state=xyz
...
def parse_implicit_response(uri, state=None, scope=None):
    ...
    **state**
    ...
    .. code-block:: http
        ...
        HTTP/1.1 302 Found
        Location: http://pyseeker.com/cb#access_token=2YotnFZFEjr1zCsicMWpAA
